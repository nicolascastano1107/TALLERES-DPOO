...
public class PersistenciaTiquetesJson implements IPersistenciaTiquetes
{
    ...
    private void cargarClientes( Aerolinea aerolinea, JSONArray jClientes ) throws ClienteRepetidoException, JSONException
    {
        ...
        for( int i = 0; i < numClientes; i++ )
        {
            ...
            System.out.println(tipoCliente+" "+ClienteNatural.NATURAL );
     ...
     */
    public void cargarTiquetes( Aerolinea aerolinea, JSONArray jTiquetes ) throws InformacionInconsistenteTiqueteException
    {
       ...
       public void cargarRutas(Aerolinea aerolinea, JSONArray jsonRutas) throws InformacionInconsistenteException {
            for (int i = 0; i < jsonRutas.length(); i++) {
                JSONObject obj = jsonRutas.getJSONObject(i);
                ...
                String origen = obj.getString("origen");
                String destino = obj.getString("destino");

                Aeropuerto aeropuertoOrigen = new Aeropuerto(origen, origen, origen, 0.0, 0.0);
                Aeropuerto aeropuertoDestino = new Aeropuerto(destino, destino, destino, 0.0, 0.0);
